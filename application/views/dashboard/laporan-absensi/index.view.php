<div class="col-lg-5 mx-auto">
    ...
    <div class="card ">
        ...
        <form action="<?= BASE_PATH ?>/dashboard/laporanabsensi/cetak" method="POST" target="_blank">
            <div class="card-body">
            ...
            <div class="card-footer">
                <button style="width: 100%;" type="submit" class="btn btn-primary"><i class="fa fa-print"></i> Cetak Laporan Absensi</button>
            </div>
        </form>
    </div>
</div>