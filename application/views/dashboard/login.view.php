...
<head>
    ...
    <title>Penggajian App - Login</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" role="form" action="<?= BASE_PATH ?>/login/check" method="post">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?= BASE_PATH ?>/register">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
