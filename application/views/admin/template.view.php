...
<head>
    ...
    <title>Administrator - <?= $breadcrumb ?></title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= BASE_PATH ?>/admin">
            ...
            <?php
            create_menu("admin", "tachometer-alt", "Dashboard");
            create_multymenu(array("admin/user" => "Data Perusahaan", "admin/karyawan" => "Data Karyawan", "admin/jabatan" => "Data Jabatan"), "database", "Master Data");
            create_multymenu(array("admin/absensi" => "Data Absensi", "admin/penggajian" => "Data Gaji"), "digital-tachograph", "Transaksi");
            create_menu("admin/setting", "cogs", "Setting");
            ?>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?= BASE_PATH ?>/admin/setting">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?= BASE_PATH ?>/admin/logout">Logout</a>
                </div>
            </div>
        </div>
    </div>
